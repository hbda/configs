...
plugins=(rails ruby bundler capistrano gem osx ssh-agent rake rbenv command-not-found compleat composer cp history history-substring-search git-remote-branch git git-flow git-extras github pow)
